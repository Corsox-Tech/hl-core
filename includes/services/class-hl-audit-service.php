...
class HL_Audit_Service {
     ...
     * @param array  $data        Optional: partnership_id, entity_type, entity_id, before_data, after_data, reason
     */
    public static function log($action_type, $data = array()) {
        ...
        $wpdb->insert($wpdb->prefix . 'hl_audit_log', array(
            ...
            'partnership_id'     => isset($data['partnership_id']) ? $data['partnership_id'] : null,
