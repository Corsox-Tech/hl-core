...
class HL_Frontend_Child_Assessment {
    ...
    private function resolve_instance_from_component( $component_id ) {
        ...
        $wpdb->insert( $wpdb->prefix . 'hl_child_assessment_instance', array(
            ...
            'cycle_id'           => absint( $component->cycle_id ),
