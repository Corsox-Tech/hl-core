...
class HL_CLI_Create_Pages {
    ...
    private function get_page_definitions() {
        return array(
            ...
            array( 'title' => 'My Cycle',         'shortcode' => 'hl_my_cycle' ),
            ...
            array( 'title' => 'Cycle Workspace',  'shortcode' => 'hl_cycle_workspace' ),
            array( 'title' => 'Cycle Dashboard',  'shortcode' => 'hl_cycle_dashboard' ),
