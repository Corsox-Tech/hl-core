...
| A4 | Admin pages track→partnership | 2026-03-13 | 17 files | HL_Admin_Tracks→HL_Admin_Partnerships, deleted class-hl-admin-tracks.php, cleaned 12 admin files + import wizard JS; remaining: hl_track_email_log (table not renamed), track_roles (CSV format) |
