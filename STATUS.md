...
> **Progress:** 13 / 52 tasks complete — **Track 3 foundation + Tasks 6–12 in flight on `feature/email-v2-track3-backend`**

**Branches:**
- `feature/email-v2-track3-backend` — foundation + Rev 35 + admin UX + draft envelope + Rev 36 + stale sweep + dedup contract + column guard (13/32 tasks done — Tasks 1–10, 11, 12, 23 all landed + polish §3-§9)
