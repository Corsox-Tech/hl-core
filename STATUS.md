...
> **Progress:** 23 / 52 tasks complete — **Track 3 Tasks 1-22 + 23 in flight on `feature/email-v2-track3-backend`**

**Branches:**
- `feature/email-v2-track3-backend` — foundation + Rev 35 + admin UX + draft envelope + Rev 36 + stale sweep + dedup + column guard + 5 cron queries + cron staleness + Rev 37 role scrub (23/32 tasks done — Tasks 1–22, 23 all landed + polish §3-§9)
