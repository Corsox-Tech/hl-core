...
> **Progress:** 19 / 52 tasks complete — **Track 3 Tasks 1-18 + 23 in flight on `feature/email-v2-track3-backend`**

**Branches:**
- `feature/email-v2-track3-backend` — foundation + Rev 35 + admin UX + draft envelope + Rev 36 + stale sweep + dedup + column guard + 5 cron queries + cron staleness Site Health (19/32 tasks done — Tasks 1–18, 23 all landed + polish §3-§9)
