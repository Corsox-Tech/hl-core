...
> **Progress:** 18 / 52 tasks complete — **Track 3 foundation + Tasks 6–17 in flight on `feature/email-v2-track3-backend`**

**Branches:**
- `feature/email-v2-track3-backend` — foundation + Rev 35 + admin UX + draft envelope + Rev 36 + stale sweep + dedup contract + column guard + 5 real cron queries (18/32 tasks done — Tasks 1–17, 23 all landed + polish §3-§9)
